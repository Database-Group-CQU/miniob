...
RC Db::alter_table_drop(const char *table_name, const std::string attribute_name)
{
  RC rc = RC::SUCCESS;
  ...
  rc = table->alter_drop(table_name, table_file_path.c_str(), path_.c_str(), attribute_name);
